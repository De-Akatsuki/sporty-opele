    ...
    <>
      <div className="flex h-screen bg-[#f6f9fc] overflow-hidden relative">
        ...
        <div className="flex-1 md:ml-60 flex flex-col overflow-y-auto relative z-10">
          ...
          <Routes>
            <Route path="/" element={<Dashboard onMenuClick={() => setMobileOpen(true)} />} />
            <Route path="/teams" element={<Teams onMenuClick={() => setMobileOpen(true)} />} />
            <Route path="/performance" element={<Performance onMenuClick={() => setMobileOpen(true)} />} />
          </Routes>
        </div>
      </div>
